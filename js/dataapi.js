 ...
 classement.then(data => {
    ...
    data.standings.forEach(standT => {
        ...
        <tr>
          ...
          <td><img class="responsive-img" width="24" height="24" src="${result.team.crestUrl}" onerror="this.onerror=null;this.src='./club.svg'">${result.team.name}</td>
          <td>${result.won}</td>
          <td>${result.draw}</td>
          <td>${result.lost}</td>
  ...
  console.log("pewored by api");
    ...
    let html = "";
        ...
        <a href="./detailclub.html?id=${team.id}">
            <div class="card">
                <img src="${url}" width="150" height="100" onerror="this.onerror=null;this.src='/../club.svg'" style="padding : 10px">
      ...
      <div class="col s12 m12">
        <div class="card">
          <div class="card-image">
            <img src="${data.crestUrl}" height="300" onerror="this.onerror=null;this.src='club.svg'">
          </div>
          <div class="card-content">
...
const getSavedTeamById = () => {
  ...
  .then(favorite => {
    ...
    <div class="col s12 m12">
      <div class="card">
        <div class="card-image">
          <img src="${favorite.crestUrl}" height="300" onerror="this.onerror=null;this.src='club.svg'">
        </div>
        <div class="card-content">
